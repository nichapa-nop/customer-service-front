      ...
      <div className="w-full">
        <div className="flex w-full h-full">
          <div className=" w-full flex flex-col justify-between">
              ...
              <table className="bg-white w-full table-fixed items-center justify-center text-center">
                ...
                <tbody>
                  <tr className="h-[68px] hover:bg-light-orange ">
                    <td className="text-left pl-12">Employee</td>
                  ...
                  <tr className="h-[68px] hover:bg-light-orange ">
                    <td className="text-left pl-12">Manager</td>
                    <td className="text-left pl-12">
                      Group A: One, Two, Three, Four, Five, Six, Seven, Eight,
                      Nine, Ten, Eleven
                    </td>
                  ...
                  <tr className="h-[68px] hover:bg-light-orange ">
                    <td className="text-left pl-12">Trainee</td>
                    <td className="text-left pl-12">
                      Group A: One, Two, Three, Four, Five, Six, Seven, Eight,
                      Nine, Ten, Eleven
                    </td>
                  ...
                  <tr className="h-[68px] hover:bg-light-orange ">
                    <td className="text-left pl-12">CEO</td>
                    <td className="text-left pl-12">
                      Group A: One, Two, Three, Four, Five, Six, Seven, Eight,
                      Nine, Ten, Eleven
                    </td>
            ...
            <footer className="flex items-center justify-between p-6 mt-auto">
              <div className="mx-4 text-dark-gray">1 Items</div>
