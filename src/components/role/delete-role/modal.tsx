...
interface Props {
  ...
  onClose?: () => void;
  setIsDeleteRoleSuccessModalOpen: Dispatch<SetStateAction<boolean>>;
  setLatestDeleteRole: Dispatch<SetStateAction<RoleResponse | undefined>>;
}

const DeleteRoleModal: React.FC<Props> = ({
  isOpen,
  onClose,
  setIsOpen,
  initialRole,
              ...
              <DialogPanel className="bg-white w-[650px] h-[460px] border rounded-[20px] p-12 ">
                ...
                <div className="flex flex-col h-[120px] rounded-xl mb-6 items-center justify-center">
                  ...
                  <p className=" text-[16px] text-center">
                    ...
                    action is <br />
                    irreversible and will permanently remove this role from the
                    system.
                  </p>
                </div>
